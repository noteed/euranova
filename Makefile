...
topologies/target/classes/com/noteed/stormcase/Topology.class: topologies/com/noteed/stormcase/Topology.java
	mkdir -p m2
	docker run \
...
topologies/target/stormcase-0.1.0-jar-with-dependencies.jar: topologies/target/classes/com/noteed/stormcase/Topology.class
	docker run \
          -v `pwd`/m2:/home/storm/.m2 \
          -v `pwd`/topologies:/home/storm/topologies \
